...
//   }, ROUTES);
// };
// const imgUrl = "/assets/logo-marchantes.b857cd6b.png";
// const imgtoUrl = "/assets/btn_google_signin_light_normal_web@2x.1811e950.png";
// /**
//  * @license
...
// const createUser = (emailR, passwordR) => createUserWithEmailAndPassword(auth, emailR, passwordR).then((userCredential) => {
//   userCredential.user;
//   onNavigate("/muro");
...
//   return pf(_h(db, "Publicacion"), {
//     text: data,
//     email: auth.currentUser.email
//   });
// }
// function listarPublicaciones(callback) {
//   const queryPost = Rl(_h(db, "Publicacion"));
//   If(queryPost, callback);
// }
// async function borrarTexto(docId) {
//   console.log("DOC ID: ", docId);
//   await yf(gh(db, "Publicacion", docId));
// }
// async function editoPost(docId, actualizarPost) {
//   const docEditar = gh(db, "Publicacion", docId);
//   await gf(docEditar, {
//     text: actualizarPost
//   });
// }
...
//   claveInput.placeholder = "Contrase\xF1a";
...
//     loginGoogle().then((rep) => {
//       onNavigate("/muro");
//     }).catch((err) => {
//       alert("No se pudo iniciar sesi\xF3n con Google");
//     });
//   });
//   const botonRegistro = document.createElement("section");
//   botonRegistro.classList.add("botonRegistro");
//   botonRegistro.innerHTML = '\xBFNo tienes una cuenta? <a href="#">Reg\xEDstrate</a>.';
...
//   iniciarSesionBtn.textContent = "Iniciar sesi\xF3n";
...
//   claveRegistro.placeholder = "Contrase\xF1a";
...
//   botonVolver.textContent = "\u2B05\uFE0E Volver atr\xE1s";
...
//   btnExit.textContent = "Cerrar sesi\xF3n";
